...
'''
#Load data
file1 = pd.read_csv('HA_Pst_stock_rep1_barcode_clusters.csv')
file2 = pd.read_csv('HA_Pst_stock_rep2_barcode_clusters.csv')
file3 = pd.read_csv('HA_Pst_stock_rep3_barcode_clusters.csv')
file4 = pd.read_csv('HA_Pst_stock_rep4_barcode_clusters.csv')
...
stock_rep_concat.to_csv('HA_Pst_stockreps_concat.csv')
...
concat_dedup.to_csv('HA_Pst_stockreps_concat_DEDUP.csv')
...
pd.DataFrame.from_dict(data=test_dict, orient='index').to_csv('HA_Pst_stockreps_OVERLAP_COUNTS.csv', header=False)
'''
counting_df=pd.read_csv('HA_Pst_stockreps_OVERLAP_COUNTS.csv',names=["barcode_clusters", "Coverage"])
c1=0
c2=0
c3=0
c4=0
for num in counting_df['Coverage']:
    if num == 1:
        ...
        print('YIKES')
print('PstI Stock HA representation')
