...
pst_L = pd.read_csv('PA_Pst_L_rep1_barcode_clusters.csv')
pst_LL = pd.read_csv('PA_Pst_LL_rep1_barcode_clusters.csv')
pst_LR = pd.read_csv('PA_Pst_LR_rep1_barcode_clusters.csv')
pst_NA = pd.read_csv('PA_Pst_NA_rep1_barcode_clusters.csv')
pst_R = pd.read_csv('PA_Pst_R_rep1_barcode_clusters.csv')
pst_RR = pd.read_csv('PA_Pst_RR_rep1_barcode_clusters.csv')
stock = pd.read_csv('PA_Pst_stock_rep1_barcode_clusters.csv')

#these have to be done alphabetically, I don't know how to fix that
df_list=[pst_L, pst_LL, pst_LR, pst_NA, pst_R, pst_RR, stock]
...
df_concat.to_csv('Pst_mice_PA_rep1_concat.csv')
#PIVOT!
...
ax=df_pivot.plot.barh(stacked=True, 
                   legend=False, 
                   color=PA_colors, 
                   title=' Clustered PA barcodes (rep 1), PstI infected mice',
                   )
ax.set_xlabel("Frequency (%)")

plt.tight_layout()
plt.savefig('Pst_mice_PA_rep1.png',dpi=300)
plt.savefig('Pst_mice_PA_rep1.svg',dpi=300)
#plt.show()