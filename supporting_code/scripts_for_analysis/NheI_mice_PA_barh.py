...
nhe_L = pd.read_csv('PA_Nhe_L_rep1_barcode_clusters.csv')
nhe_LL = pd.read_csv('PA_Nhe_LL_rep1_barcode_clusters.csv')
nhe_LR = pd.read_csv('PA_Nhe_LR_rep1_barcode_clusters.csv')
nhe_NA = pd.read_csv('PA_Nhe_NA_rep1_barcode_clusters.csv')
nhe_R = pd.read_csv('PA_Nhe_R_rep1_barcode_clusters.csv')
nhe_RR = pd.read_csv('PA_Nhe_RR_rep1_barcode_clusters.csv')
stock = pd.read_csv('PA_Nhe_stock_rep1_barcode_clusters.csv')
...
df_concat.to_csv('Nhe_mice_PA_rep1_concat.csv')
#PIVOT!
...
ax=df_pivot.plot.barh(stacked=True, 
                   legend=False, 
                   color=PA_colors, 
                   title=' Clustered PA barcodes (rep 1), NheI infected mice',
                   )
ax.set_xlabel("Frequency (%)")

plt.tight_layout()
plt.savefig('Nhe_mice_PA_rep1.png',dpi=300)
plt.savefig('Nhe_mice_PA_rep1.svg',dpi=300)
#plt.show()